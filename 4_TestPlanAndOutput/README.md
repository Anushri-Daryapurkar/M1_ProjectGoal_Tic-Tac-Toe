...
|--------|-------------|---------|---------|
|H_01    |  Check whether the grid being drawn or not.           |    No input.     |      3X3 grid is drawn.   |
...
|L_02    |  Play proceeds with the user/computer alternately placing their marks in unoccupied square. Check if any player/computer finishes  with 3 marks in a row(vertical, horizontal or diagonal). |   'X' or 'O' i/p from the User/Computer.      |   The User/Computer won the game.      |
